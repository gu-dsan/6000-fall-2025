---
title: "Lab 2: EC2 Setup and VSCode Remote Development"
...
3. **Instance type**: 
   - Select **t3.xlarge** from the dropdown
   - This provides 4 vCPUs and 16 GiB of memory, suitable for data science workloads
   - As of September 2025 in us-east-1, this instance costs approximately $0.22 per hour (roughly $1 for 5 hours)
...
Complete today's assignment here: [{{< var gh-classroom.lab02 >}}]({{< var gh-classroom.lab02 >}})