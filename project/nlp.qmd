...
# date: last-modified
date: "2023-10-27 08:07:00 PM"
date-format: "dddd MMM D, YYYY [at] hh:mm a"
---

::: {.callout-important}
**You should read through the entire milestone instructions before beginning your work! Don't start the cloud resources until you are ready.**

**Code and data saved locally on the cluster will be lost when the cluster terminates. Remember to save intermediate and analytical datasets to a location you can access again. Your deliverable artifacts (charts, summary csv files, etc.) must be saved in the `data/` folder of this repo.**
...
1. Install the SparkNLP package to your Spark environment. Refer to the labs for examples of installing SparkNLP into a Sagemaker or Azure Spark environment.
