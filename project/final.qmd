...
This final milestone is worth 40% of your final grade. Thus, we expect you to put ***significant*** effort into this. 

**You should read through the entire milestone instructions before beginning your work! Don't use computing resources until you are ready.**

## Table of Contents

- [Milestone 4: Final Deliverable](#milestone-4-final-deliverable-90-points)
  - [Table of Contents](#table-of-contents)
  - [Setup](#setup)
  - [Milestone description](#milestone-description)
  - [Analysis Requirements](#analysis-requirements)
  - [Final milestone web page requirements](#final-milestone-web-page-requirements)
    - [Reviewing and editing your existing website](#reviewing-and-editing-your-existing-website)
    - [Introduction page](#introduction-page)
    - [NLP and ML pages](#nlp-and-ml-pages)
    - [Discussion page](#feedback-discussion-page)
...
- `docs/discussion.html`

You will update and improve the following pages:
- `docs/eda.html`
- `docs/nlp.html`
- `docs/ml.html`
