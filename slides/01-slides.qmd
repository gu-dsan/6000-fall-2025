...
::: {.column width="25%"}
![](../content/img/amit.jpeg 'Amit Arora')
:::
::::
...
* Background in Computational Social Science (Computer Science MS &rarr; Political Economy PhD &rarr; Labor Econ Postdoc)
...
::: {.column width="25%"}
![](../content/img/jeff.jpg 'Jeff Jacobs')
:::
::::
...
* Sleep disorder means lots of [reading](https://app.thestorygraph.com/profile/jpowerj) -- mainly history! -- at night when I can't sleep
...
* Hahana Kim, [`hk932@georgetown.edu`](mailto:hk932@georgetown.edu)
