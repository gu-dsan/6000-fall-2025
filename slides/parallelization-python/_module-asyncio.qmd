...
- References: [asyncio — Asynchronous I/O](https://docs.python.org/3/library/asyncio.html), [Async IO in Python: A Complete Walkthrough](https://realpython.com/async-io-python/)
