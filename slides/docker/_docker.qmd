...
![](docker/img/meme_ship_machine.png)
...
![](docker/img/virtualization-timeline.png)
...
![](docker/img/container-diagram.png)
...
![](docker/img/vm-vs-container.PNG)
...
![](docker/img/Docker-Architecture.png)

## Containers are not enough

![](docker/img/containers-dont-solve-everything.jpg)

## Container lifecycle

* Containers (like applications) need a lifecycle

![](docker/img/container-lifecycle.png)

## Container orchestration

![](docker/img/container-orchestration.jpg)
...
![](docker/img/docker-base-images.png)
...
![](docker/img/docker-cmd-entrypoint.png)
